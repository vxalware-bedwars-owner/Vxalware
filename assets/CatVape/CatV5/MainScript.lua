...
-- pro code I think should work idrk 💀
    ...
    local fileList = {
        ...
        "closet client6872274481.txt", "closet16008862571.txt", "closet6872265039.txt",
        "closet6872274481.txt", "closet8444591321.txt", "color.txt", "commit.txt",
        ...
        "default142823291.txt", "default168556275.txt", "default17625359962.txt",
        "default17750024818.txt", "default2788229376.txt", "default283721918.txt",
        "default443406476.txt", "default4442272183.txt", "default4483381587.txt",
        "default6872265039.txt", "default6872274481.txt", "default8768229691.txt",
        "default893973440.txt", "default95004353881831.txt", "default96342491571673.txt",
        "gui.txt", "hud.txt", "language.txt", "non.txt", "panic v26872274481.txt",
        "panic6872265039.txt", "panic6872274481.txt", "pistonaire nut6872265039.txt",
        "pistonaire nut6872274481.txt", "silent (only legit reach)6872265039.txt",
        "silent (only legit reach)6872274481.txt", "spotify.txt",
        "trillionaire config6872265039.txt", "trillionaire config6872274481.txt",
        "whitelist.json"
    }
