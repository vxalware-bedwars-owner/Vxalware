...
elseif device == "Mobile" then
    ...
    local fileList = {
        ...
        "closet client6872265039.txt", "closet client6872274481.txt", "closet6872265039.txt", "closet6872274481.txt",
        "color.txt", "commit.txt", "default10449761463.txt", "default11630038968.txt", "default11979315221.txt",
        ...
        "gui.txt", "hud.txt", "language.txt", "non.txt", "panic6872265039.txt", "panic6872274481.txt",
        "pistonaire nut6872265039.txt", "silent (only legit reach)6872265039.txt", "spotify.txt",
        "trillionaire config6872265039.txt", "trillionaire config6872274481.txt", "whitelist.json"
    }
