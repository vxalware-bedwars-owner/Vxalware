...
atmosphere.Offset = 0
atmosphere.Color = Color3.fromRGB(80, 200, 120)
atmosphere.Decay = Color3.fromRGB(40, 100, 60)

lighting.TimeOfDay = "21:00:00"
lighting.Brightness = 2
lighting.Ambient = Color3.fromRGB(70, 110, 90)
lighting.OutdoorAmbient = Color3.fromRGB(80, 120, 100)
lighting.FogStart = 200
lighting.FogEnd = 1200
lighting.FogColor = Color3.fromRGB(90, 190, 110)
...
print("[Atmosphere Changer] Successfully applied Green Atmosphere")
